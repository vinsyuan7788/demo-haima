...
import com.demo.haima.test.integration.demo.utils.data.network.base.DataUtils;
 ...
 * @date 2021/11/20
 */
public class NioDataSimplexServerSocket extends ContainerRunner implements Runnable, DataSimplexServerSocket {

    private static final Logger LOG = LoggerFactory.getLogger(NioDataSimplexServerSocket.class);
    ...
    public NioDataSimplexServerSocket(int portToBind) {
        try {
    ...
    public void processSelectedKeys(Set<SelectionKey> selectedKeys) throws Exception {
        ...
        // Clean the ready channels that have been processed from the selector
        selectedKeys.clear();
    }
    ...
    public void processReadEvent(SelectionKey selectedKey) throws Exception {
        ...
        String data = DataUtils.readByteBuffer(byteBuffer);
