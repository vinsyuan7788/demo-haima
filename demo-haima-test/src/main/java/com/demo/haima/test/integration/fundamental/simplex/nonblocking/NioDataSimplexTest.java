...
import com.demo.haima.fundamental.client.simplex.nonblocking.DataSimplexClient;
import com.demo.haima.fundamental.client.simplex.nonblocking.NioDataSimplexClient;
import com.demo.haima.fundamental.server.simplex.nonblocking.DataSimplexServer;
import com.demo.haima.fundamental.server.simplex.nonblocking.NioDataSimplexServer;
...
public class NioDataSimplexTest {
    ...
    public void test2() throws Exception {
        ...
        for (DataSimplexClient client : clientList) {
            client.closeClient();
        }
