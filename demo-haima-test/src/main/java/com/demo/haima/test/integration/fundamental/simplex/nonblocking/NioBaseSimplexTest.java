...
import com.demo.haima.fundamental.client.simplex.nonblocking.BaseSimplexClient;
import com.demo.haima.fundamental.client.simplex.nonblocking.NioBaseSimplexClient;
import com.demo.haima.fundamental.server.simplex.nonblocking.BaseSimplexServer;
import com.demo.haima.fundamental.server.simplex.nonblocking.NioBaseSimplexServer;
 ...
 * @date 2021/11/20
 */
public class NioBaseSimplexTest {
    ...
    public void testStartServer() throws Exception {
        server = new NioBaseSimplexServer(8686);
        server.startServer();
    ...
    public void test1() throws Exception {
        client = new NioBaseSimplexClient(new InetSocketAddress(8686));
        client.startClient();
