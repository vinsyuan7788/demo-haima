...
import com.demo.haima.fundamental.client.simplex.nonblocking.PacketSimplexClient;
import com.demo.haima.fundamental.server.simplex.nonblocking.NioPacketSimplexServer;
import com.demo.haima.fundamental.server.simplex.nonblocking.PacketSimplexServer;
...
public class NioPacketSimplexTest {
    ...
    public void test2() throws Exception {
        ...
        for (PacketSimplexClient client : clientList) {
            client.closeClient();
        }
