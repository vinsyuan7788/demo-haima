package com.demo.haima.test.integration.demo.communication.nonblocking.duplex.client.socket;
...
import com.demo.haima.test.integration.demo.communication.nonblocking.simplex.client.socket.NioDataSimplexClientSocket;
 ...
 * @date 2021/11/20
 */
public interface BaseDuplexClientSocket {
     ...
     * manually to ensure the socket thread can exit the running method correctly. It will
     * cause an {@link InterruptedException}, which is OK in this scenario. See
     * {@link #handleRunningThrowable(Throwable)} for more details <br/>
     */
    void closeSocket();
